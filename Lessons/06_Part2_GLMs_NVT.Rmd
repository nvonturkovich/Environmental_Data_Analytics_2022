...
Linear model = two continutous variables, line of best fit, deviation from line of best fit
ANOVA = deviation across two means, does the variance change if we categorize things
...
#low p value is bad, dont want significance of difference. want data to be distributed around the mean. not around 0
...
```{r}
# Format as aov
#null = no difference in means across populations
#alt =  yes difference in means
#low p means statistically sig, reject the null, there is some difference in means
