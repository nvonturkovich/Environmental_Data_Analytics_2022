...
NTL.nutrient.data.PeterPaul <- droplevels(NTL.nutrient.data.PeterPaul)#drop levels gets ride of other categories even if there are 0 obersvations
summary(NTL.nutrient.data.PeterPaul$lakename)
...
NTL.nutrient.data.PeterPaul.gathered <- subset(NTL.nutrient.data.PeterPaul.gathered, !is.na(concentration)) #removes NAs from concentration column
...
### rbind - row bind, combining data sets by row
