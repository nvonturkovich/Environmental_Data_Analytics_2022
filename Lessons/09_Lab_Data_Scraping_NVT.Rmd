...
```{r }
#Set the URL
theURL2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb' #just change the site name and the period

#Get the data, which starts on line 30
gage_data2 <- read.table(theURL2,skip = 28,header=TRUE,sep='\t') 
...
Forms a URL and sends that request to the website
...
electricity_df<-data.frame(
  ...
  "Capacity" = as.numeric(gsub(",","",the_capacity)),#gsub gets rid of commas - needed to make as.numeric work
