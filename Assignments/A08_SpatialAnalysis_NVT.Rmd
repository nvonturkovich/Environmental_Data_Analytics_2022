...
> ANSWER:
> Columns "dec_lat_va" and "dec_long_va" contain the x and y coordinate values. 
...
triangle_HUCs<-NWIS_Flow_join_utm %>% 
  filter(st_within(x=., y=Lancaster_co, sparse = F))

triangle_HUCs2<-NWIS_Flow_join_utm[Lancaster_co]
...
ggplot()+
  ...
  geom_sf(data=triangle_HUCs, color='black', alpha=.5)+
  labs(title="NWIS Gage Locations in Lancaster County Nebraska", subtitle = "Natalie von Turkovich")


mapview(list(counties_sf_utm, Lancaster_co, triangle_HUCs),
