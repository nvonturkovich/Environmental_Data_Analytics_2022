...
O3_GNC_19 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2019_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_18 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2018_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_17 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2017_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_16 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2016_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_15 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2015_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_14 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2014_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_13 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2013_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_12 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2012_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_11 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2011_raw.csv", 
                      stringsAsFactors = TRUE)
O3_GNC_10 <- read.csv("Data/Raw/Ozone_TimeSeries/EPAair_O3_GaringerNC2010_raw.csv", 
                      stringsAsFactors = TRUE)
...
GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$MeanOzone, 
          start = c(fmonth_monthly,fyear_monthly), frequency = 12)
...
ggplot(GaringerOzone.monthly, aes(x = Date, y = MeanOzone)) +
  ...
  geom_line() +
  geom_smooth( method = lm )+
  labs(y="Mean Ozone Concentrations", x="Year")
